...
import PtaProducts from './components/PtaProducts.js'; // Sản phẩm
import PtaNews from './components/PtaNews'; // Tin tức
...
export default function PtaApp() {
  ...
  // Hàm xử lý sự kiện thêm mới người dùng
    ...
    <div className="container border my-3">
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/products" element={<PtaProducts />} /> {/* Sản phẩm */}
          <Route path="/news" element={<PtaNews />} /> {/* Tin tức */}
