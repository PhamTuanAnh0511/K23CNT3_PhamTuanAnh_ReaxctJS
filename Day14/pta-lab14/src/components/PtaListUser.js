...
export default function PtaListUser() {
    ...
    return (
        <div className="container mt-4" style={{ backgroundColor: '#1e1e1e', padding: '40px', borderRadius: '10px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.3)', color: '#fff' }}>
            <div className="alert alert-info" style={{ backgroundColor: '#343a40', color: '#fff', border: 'none' }}>
                <h2>Danh sách người dùng</h2> {/* Tiêu đề */}
            </div>
            <div className="table-responsive">
                <table className="table table-bordered table-striped" style={{ backgroundColor: '#333', color: '#fff' }}>
                    ...
                    <tbody style={{ backgroundColor: '#444' }}>
